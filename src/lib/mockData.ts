...
export const MOCK_STORIES = [
  {
    ...
    lat: 6.6924,
    lng: -1.6244,
    description: "An oral preservation of the historical symbol of unity and spirit of the Ashanti people, detailing how it was conjured from the heavens by the high priest Okomfo Anokye.",
    audio: "",
  ...
  {
    _id: "65a0b1c2d3e4f5a6b7c8d9e1",
    userId: "mock_user_2",
    userName: "Kenji Sato",
    title: "Whispers of the Bamboo Forest",
    region: "Kyoto, Japan",
    language: "Japanese",
    narrator: "Sato-sensei",
    category: "Stories",
    score: 88,
    lat: 35.0116,
    lng: 135.7681,
    description: "A captivating narration of folklore centered around the spirits of Arashiyama, and how the rustle of the bamboo leaves has served as a guide for travelers seeking inner peace for centuries.",
    audio: "",
  ...
  {
    _id: "65a0b1c2d3e4f5a6b7c8d9e2",
    userId: "mock_user_3",
    userName: "Elena Rostova",
    title: "The Midsummer Fire Festival Songs",
    region: "Karelia, Russia",
    language: "Russian",
    narrator: "Babushka Valentina",
    category: "Music",
    score: 95,
    lat: 61.7849,
    lng: 34.3469,
    description: "Authentic recordings and explanations of the ancient Kupala songs sung by local elders during the summer solstice, celebrating nature, fertility, and community bonding.",
    audio: "",
...
export const MOCK_CONTRIBUTIONS = [
  {
    _id: "65a0b1c2d3e4f5a6b7c8d9e3",
    userId: "mock_user_1",
    title: "The Art of Murano Glass Blowing",
    category: "Crafts",
    region: "Venice, Italy",
    contributor: "Giovanni Moretti",
    description: "A detailed guide and historical documentation on the intricate techniques of glasswork preserved on Murano island since the 13th century, focusing on the preservation of the secret furnace recipes.",
    image: "https://images.unsplash.com/photo-1505678261036-a3fcc5e884ee?w=800&q=80",
    audio: "",
    lat: 45.4384,
    lng: 12.3188,
    tags: ["Glass", "Venice", "Artisan", "Tradition"],
    culturalEra: "Medieval",
    sourceType: "Historical Oral Tradition",
    ...
    featured: true,
    status: "Approved",
    references: ["Venetian Archives Vol. IV", "Oral accounts of master glassmakers"],
    gallery: [],
    commentsCount: 2,
    bookmarks: 15,
  ...
  {
    _id: "65a0b1c2d3e4f5a6b7c8d9e4",
    userId: "mock_user_2",
    title: "Ancient Mayan Calendar Systems",
    category: "Literature",
    region: "Yucatan, Mexico",
    contributor: "Mateo Canul",
    description: "An exploration of the mathematical and astronomical alignments behind the Tzolk'in and Haab' calendars, highlighting the oral traditions of modern Yucatec Maya elders who keep these cycles.",
    image: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800&q=80",
    audio: "",
    lat: 20.6843,
    lng: -88.5678,
    tags: ["Mayan", "Yucatan", "Astronomy", "Calendar"],
    culturalEra: "Ancient",
    sourceType: "Living Heritage",
    ...
    inspiringVotes: 56,
    heritageVotes: 62,
    badge: "Elder Custodian",
    verified: true,
    featured: true,
    status: "Approved",
    references: ["Codex Dresdensis studies", "Yucatec oral archives"],
    gallery: [],
    commentsCount: 5,
    bookmarks: 42,
  ...
  {
    _id: "65a0b1c2d3e4f5a6b7c8d9e5",
    userId: "mock_user_3",
    title: "Traditional Wayang Kulit Puppetry",
    category: "Art",
    region: "Java, Indonesia",
    contributor: "Ki Anom Soeroto",
    description: "A comprehensive overview of Javanese shadow puppet theatre, focusing on the puppet-making process from water buffalo hide and the spiritual role of the Dalang (puppet master) in community rituals.",
    image: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=800&q=80",
    audio: "",
    lat: -7.8014,
    lng: 110.3739,
    tags: ["Wayang Kulit", "Puppetry", "Java", "UNESCO"],
    culturalEra: "Renaissance",
    sourceType: "Performing Arts",
    preservationStatus: "Active",
    importanceLevel: "High",
    heritageScore: 91,
    likes: 195,
    ...
    featured: false,
    status: "Approved",
    references: ["UNESCO Intangible Cultural Heritage Inscription 2008"],
    gallery: [],
    commentsCount: 3,
    bookmarks: 28,
    createdAt: "2024-06-20T17:00:00.000Z"
  }
];
